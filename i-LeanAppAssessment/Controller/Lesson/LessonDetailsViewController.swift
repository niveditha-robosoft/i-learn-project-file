...
//        if let cell = collectionView.cellForItem(at: indexpath) as? BottomUpCollectionViewCell {
...
//        }
    ...
    @IBAction func rightButtonTapped(_ sender: Any) {
        ...
        objectOfLessonViewModel.callForLessonDetail(URLString: "https://app-e-learning-221207163844.azurewebsites.net/user/view/unitDetails?unitId=\(407)&limit=1&page=\(currentPageNo)"){ [self] data in
    ...
    @IBAction func okButtontapped(_ sender: Any) {
        print("NNNNNNNNNNNNN",SelectedCellLabel)
        objectOfLessonViewModel.callForLessonDetail(URLString: "https://app-e-learning-221207163844.azurewebsites.net/user/view/unitDetails?unitId=407&limit=1&page=\(String(SelectedCellLabel))"){ data in
            if data == true {
                self.titleLabel.text = self.objectOfLessonViewModel.lessonDetail.last?.pageTitle
                self.contentTextView.text = self.objectOfLessonViewModel.lessonDetail.last?.unitDescription
            }
