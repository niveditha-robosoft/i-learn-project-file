//
//  AboutSubjectHeaderProgress.swift
//  i-LeanAppAssessment
//
//  Created by Harsha R Mundaragi on 19/12/22.
//

import Foundation
import UIKit

class AboutHeaderProgress:UIView  {
 ...
 private func createCirclePath() {
   ...
   func simpleShape() {
       ...
       shapeLayer.strokeColor = #colorLiteral(red: 0.8745098039, green: 0.8745098039, blue: 0.8745098039, alpha: 1)
